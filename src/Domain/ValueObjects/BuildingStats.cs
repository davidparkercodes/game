...
{
    /// <summary>
    /// Immutable value object representing building statistics.
    ...
    public readonly struct BuildingStats
    {
        ...
        /// <summary>
        /// Creates default building stats suitable for basic turret
        /// </summary>
        ...
        /// <summary>
        /// Calculates damage per second based on damage and fire rate
        /// </summary>
        public float DamagePerSecond => Damage / FireRate;

        /// <summary>
        /// Calculates cost effectiveness (damage per second per cost)
        /// </summary>
