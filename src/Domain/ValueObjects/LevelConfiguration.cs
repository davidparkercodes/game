...
{
    /// <summary>
    /// Immutable value object representing level configuration.
    ...
    public readonly struct LevelConfiguration
    {
        ...
        /// <summary>
        /// Creates a default level configuration with zigzag path
        /// </summary>
        public static LevelConfiguration CreateDefault()
        {
            var pathPoints = new[]
            {
                new PathPoint(100, -50),   // Start above screen
                new PathPoint(100, 150),   // Entry point
                new PathPoint(400, 150),   // Move right
                new PathPoint(400, 300),   // Move down
                new PathPoint(150, 300),   // Move left
                new PathPoint(150, 450),   // Move down
                new PathPoint(500, 450),   // Move right
                new PathPoint(500, 600),   // Move down
                new PathPoint(300, 600),   // Move left
                new PathPoint(300, 750)    // Exit below screen
            };
        ...
        /// <summary>
        /// Gets the difficulty rating based on path complexity and initial resources
        /// </summary>
        public float DifficultyRating
        {
            get
            {
                var pathComplexity = PathPoints.Count / 10.0f; // More points = more complex
                var resourceScarcity = 1000.0f / Math.Max(InitialMoney, 1); // Less money = harder
                var livesConstraint = 20.0f / Math.Max(InitialLives, 1); // Fewer lives = harder
        ...
        {
            return obj is LevelConfiguration other && Equals(other);
        }

        public bool Equals(LevelConfiguration other)
        {
        ...
        public static bool operator ==(LevelConfiguration left, LevelConfiguration right)
        {
    ...
    /// <summary>
    /// Represents a point in 2D space for path definition
    /// </summary>
